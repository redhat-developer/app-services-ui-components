...
import { Account,AclBinding,AddAclType } from './types';
...
createMachine({
  context: { account: undefined, availableUsersAndAccounts: [], addedAcls: [],existingAcls:[] ,kafkaName:''},
  ...
  schema: {
    ...
    events: {} as
      ...
      | { type: "Add ACL manually";value:AddAclType }
      | { type: "Add a consume from a topic ACL";value:AddAclType }
      | { type: "Add a produce to a topic ACL";value:AddAclType }
      | { type: "Add manage access ACL";value:AddAclType }
...
addManageAccessTemplateAcl: assign((context) => ({ addedAcls: 
  {
...context.addedAcls,
type: "manage-access", instanceName: context.kafkaName
  } 

})),
  
addProduceTopicTemplateAcl: assign((context) => ({ addedAcls: 
  {
...context.addedAcls,
type: "produce-topic", prefixRuleValue:'Is',resourceNameValue:undefined
  } 

})),
//setSelectedUsername: assign((_, event) => ({ account: event.username })),
addRawAcl: assign((context,event) => ({ addedAcls: 
  {
...context.addedAcls, 
type: event.type,
