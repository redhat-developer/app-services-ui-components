...
import { ConnectionTab as ConnectionTabComp } from "./ConnectionTab";

export default {
  component: ConnectionTabComp,
  args: {
...
} as ComponentMeta<typeof ConnectionTabComp>;

const Template: ComponentStory<typeof ConnectionTabComp> = (args) => (
  <ConnectionTabComp {...args} />
);
