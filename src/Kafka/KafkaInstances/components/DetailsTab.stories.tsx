...
export default {
  ...
  args: {
    ...
    updatedAt: new Date(2022, 6, 2).toISOString(),
    ingress: 50,
    egress: 50,
    storage: 50,
    maxPartitions: 1500,
...
TrialInstanceJustCreated.args = {
  expiryDate: addHours(new Date(), 48).toISOString(),
  plan: "developer",
};
// @ts-ignore
