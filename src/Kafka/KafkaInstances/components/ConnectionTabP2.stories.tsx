...
import { ConnectionTabP2 } from "./ConnectionTabP2";

export default {
  component: ConnectionTabP2,
  args: {
...
} as ComponentMeta<typeof ConnectionTabP2>;

const Template: ComponentStory<typeof ConnectionTabP2> = (args) => (
  <ConnectionTabP2 {...args} />
);
