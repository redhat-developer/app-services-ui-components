...
export const OverviewPage: React.FunctionComponent<OverviewPageProps> = ({
  ...
  return (
    <>
        ...
        <Stack hasGutter>
          ...
          <StackItem>
            <Button
              ...
              isLarge
              component={props => <Link {...props} data-testid="hero-buttonTryKafka" to={toKafkaHref} />}
            >
      ...
      <PageSection variant={PageSectionVariants.light} className="app-services-ui--page-section--marketing pf-u-background-color-100">
        <Bullseye>
          ...
          <Card>
            ...
            <CardFooter>
              <Button
                ...
                variant={ButtonVariant.secondary}
                component={(props) => <Link {...props} data-testid="hero-buttonTryKafka" to={toServiceRegistryHref} />}
              >
