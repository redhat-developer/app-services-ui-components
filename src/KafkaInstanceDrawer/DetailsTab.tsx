     ...
     <DetailsTabAlert creationDate={created_at}/>
      <TextContent>
        <TextList component={TextListVariants.dl}>
          {renderTextListItem(t("common:cloud_provider"), t("common:cloudProviders.aws"))}
          {renderTextListItem(
            t('common:region'),
          ...
          {renderTextListItem(t('common:created'), format(created_at,"PPPP,p"))}
          {renderTextListItem(t('common:updated'), format(updated_at,"PPPP,p"))}
        </TextList>
      </TextContent>
    </div>
  );
