...
class Chips3 extends React.Component {
  constructor(props) {
    super(props);
    const ReadText = [
      <div class="row">
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          <Chip className="custom-c-chip blue-border" isReadOnly>
            <ChipGroup
              // className="lightblue"
          ...
          <Chip className="custom-c-chip grey-border" isReadOnly>
            <ChipGroup
              // className="lightgrey"
          ...
          <Chip className="custom-c-chip green-border" isReadOnly>
            <ChipGroup
