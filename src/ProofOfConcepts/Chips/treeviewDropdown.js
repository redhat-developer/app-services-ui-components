        ...
        this.options = [
            {
                ...
                id: "g-consumer-group",
                checkProps: { "aria-label": "consumer-group-check", checked: null },
                children: [
                    {
                        name: "All",
                        id: "g-all",
                    ...
                    },
                    {
                        name: "Describe",
                        id: "g-describe",
                        checkProps: { "aria-label": "g-describe-check", checked: true }
                    },
                    {
                        name: "Read",
                        id: "g-read",
                        checkProps: { "aria-label": "g-read-check", checked: true }
                    }
                ],
            ...
            },
            {
                ...
                checkProps: { "aria-label": "kafka-instance-check", checked: true },
                children: [
                    {
                        name: "Alter",
                        id: "ki-alter",
                        checkProps: { "aria-label": "ki-alter-check", checked: true }
                    },
                    {
                        name: "Describe",
                        id: "ki-describe",
                        checkProps: { "aria-label": "ki-describe-check", checked: true }
                    }
                ],
            ...
            },
            {
                ...
                id: "t-topic",
                checkProps: { "aria-label": "topic-check", checked: null },
                children: [
                    {
                        name: "All",
                        id: "t-all",
                    ...
                    },
                    {
                        name: "Create",
                        id: "t-create",
                        checkProps: { "aria-label": "t-create-check", checked: true }
                    },
                    {
                        name: "Delete",
                        id: "t-delete",
                        checkProps: { "aria-label": "t-delete-check", checked: true }
                    },
                    {
                        name: "Describe",
                        id: "t-describe",
                    ...
                    },
                    {
                        name: "Read",
                        id: "t-read",
                        checkProps: { "aria-label": "t-read-check", checked: true }
                    },
                    {
                        name: "Write",
                        id: "t-write",
                        checkProps: { "aria-label": "t-write-check", checked: true }
                    }
                ],
                defaultExpanded: true
            },
            {
                ...
                checkProps: { "aria-label": "transactional-id-check", checked: false },
                children: [
                    {
                        name: "All",
                        id: "ti-all",
                        checkProps: { "aria-label": "ti-all-check", checked: false }
                    },
                    {
                        name: "Describe",
                        id: "ti-describe",
                        checkProps: { "aria-label": "ti-describe-check", checked: false }
                    },
                    {
                        name: "Write",
                        id: "ti-write",
                        checkProps: { "aria-label": "ti-write-check", checked: false }
                    }
                ],
                defaultExpanded: false
            }
